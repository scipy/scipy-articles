...
COO matrices are now generally more memory efficient. Importantly,
SuperLU\cite{superlu_ug99} was updated to version 5.2.1, enhancing
...
distributions, respectively. Users can now easily serialize a number of our
sprase matrix formats with the newly associated \texttt{save\_npz} function.
We've enhanced the diagonal selection API for sparse matrices to allow
