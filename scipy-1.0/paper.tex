...
Paul Dubois at Lawrence Livermore National Laboratories took over the
maintenance of Numeric and funded the writing of its
manual\footnote{http://people.csail.mit.edu/jrennie/python/numeric/numeric-manual.pdf}.
\fixme{replace this URL with numpy.org hosted version }% Make sure we host this PDF somewhere in the numpy GitHub org
...
facing the community with a rather unfortunate choice.  In 2005,
