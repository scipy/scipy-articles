...
imported many different SciPy submodules for: signal processing,
interpolation, input / output, optimization, statistics, integration,
and more. SciPy has routines for solving
