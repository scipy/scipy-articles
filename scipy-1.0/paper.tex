...
continuous integation suite using the \texttt{pytest-cov} and \texttt{gcov}
libraries.}
\label{fig:coverage}
\end{figure}
...
2017\cite{SciPyProjectGovernance}.  We have a Benevolant Dictator for Life
...
that improve the project are the prerequiste for nomination of new Council
...
\textit{This section should include key issues: sparse arrays, ndimage pixel vs
