...
uncertainity when making code changes\cite{TDD-Beck}. We write small executable
tests that verify the correctness of some component of our code, building this
up over time to increase our confidence. Monitoring the number of lines
of code in SciPy that are properly covered by unit tests is one way we maintain
some certainty that changes and new features are not harmful.
