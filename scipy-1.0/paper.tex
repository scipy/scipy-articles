...
in their own work.
\end{quote}
Python had a strong enough presence in science and engineering so that
editors were soliciting a special issue, but it was still niche enough
that the average reader would need additional information in order
to decide whether it would ``be useful in their own work.''
