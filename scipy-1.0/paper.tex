...
Paul Dubois in the Program for Climate Model Diagnosis and
Intercomparison at Lawrence Livermore National Laboratory built their
Climate Data Analysis Tools (``an open-source set of Python modules
and tools for accessing, manipulating, and plotting scientific data in
general and climate data sets in
...
By the late 90s, Travis Oliphant, a PhD student at the Mayo Clinic,
...
- Aug 20, 2001
Eric Jones announced \ref{fig:announce-0.1}
