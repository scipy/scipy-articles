...
approximately 2600 functions and classes. Adding new functionality has to
...
the software and the project move forward).  It also has an additional ~100
unique contributors for every 6-monthly release cycle.  Maintainers are
critical to the health of the project\cite{eghbal2016}; they enable contributions
from a much larger group, and their skills and efforts largely determine how
fast the project moves forward.  Anyone with the interest and skills can become
a maintainer; the SciPy Developer Guide provides guidance on how to do that.
