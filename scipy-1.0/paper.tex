...
%\begin{figure}[H]
%\centering
%\includegraphics[width=0.5\textwidth]{static/scipy_languages}
%\caption{Composition of SciPy: lines of code in each programming language as determined by the \texttt{linguist} package.
%Small ($<0.5 \%$) amounts of TeX, Matlab, Shell,
%and Makefile (not visible) provide supporting roles in tests,
