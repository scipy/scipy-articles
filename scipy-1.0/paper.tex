...
has become a \emph{de facto} standard in the community, with more than 600
unique code contributors and millions of downloads per year, despite
the absence of an official project publication, until now. The library
includes functionality spanning clustering, Fourier transforms,
...
work, we highlight some recent technical developments and provide
an overview of the capabilities and development practices of the
SciPy library.
\end{abstract}
\begin{document}
