...
on SciPy.
With traditional grant mechanisms, it is easier to buy software licenses than to support the diverse development effort needed to develop open source software—a challenge that we hope to see national funding agencies address.
The scientific Python stack is also playing an increasingly important role in industry, and while there are some encouraging signals such as TideFlow, that sector still spends comparatively little on community-developed software.
For open source projects to remain a healthy underpinning infrastructure for international scientific and industrial endeavors, it needs more diverse spending to support planning, development, management, and infrastructure.
