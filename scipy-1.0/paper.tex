...
Traditionally, a 1.0 release signals that a
library's API has reached a level of maturity and stability
that warrants trusting it inside research pipelines.
The SciPy 1.0 version numbering belies the history of a project
that has become the standard which others follow
and has seen extensive adoption in research and industry.
...
thousands of highly qualified engineers---was preposterous.
...
packages, and a variety of social activities centered around them.  The
packages in the SciPy ecosystem share high standards of implementation,
...
a low ``bus factor''---from the phrase ``hit by a bus'' and
meaning that the project depends on a small number of
specific contributors---being perhaps the most serious.
...
Guido van Rossum in the late 1980s, with an emphasis on readability
and rapid prototyping.
% https://legacy.python.org/search/hypermail/python-1992/0000.html
%
A general purpose programming language with a ``batteries included''
...
John Hunter, a graduate student
...
in their own work.
\end{quote}
In the resulting CiSE May/June 2007 special issue, Paul's overview\cite{dubois2007guest}
stated:
\begin{quote}
...
\end{quote}
While it is now more commonly accepted, Paul took the time to explain to
...
In addition to Paul's overview there were also articles introducing
Python and SciPy \cite{oliphant2007python}, IPython \cite{perez2007ipython},
and  Matplotlib \cite{hunter2007matplotlib}.
In addition to these longer introductory articles, there was a diverse set of
...
By the middle to late 2000s, SciPy matured after a long phase of significant
growth and adoption.
The informal workshops are grown into international conferences with many
hundreds of attendees, special issues are organized and published in a
leading scientific magazine, and the scope of the SciPy library
narrows, while the breadth of the ecosystem is grown and encouraged
through a new type of auxiliary package, the scikit.  The tooling,
development and release processes become more professional, grown with
a patience only affordable in open source development, leading with
best practices nowadays increasingly common in both industry and other
open source projects \cite{millman2014developing}.
...
In the early workshops, recurrent topics indicate the state of development, with
...
2004, a significant shift occurred towards application of SciPy on
...
When Paul edited the CiSE May/June 2007 special issue, Python already had a
strong enough presence in science and engineering so that editors solicited
the special issue, but it was still niche enough that the average reader
...
NumFOCUS is a 501(c)3 public charity whose mission is to
...
% stefan, gael, david, jarrod, robert
...
% First scikit (mail moving over from nipy list?)
% https://mail.python.org/pipermail/scipy-dev/2007-March/006805.html

% First scikit development:
% https://mail.python.org/pipermail/scipy-dev/2007-April/006987.html

%https://mail.python.org/pipermail/scipy-dev/2006-November/006315.html
%https://mail.python.org/pipermail/scipy-dev/2006-November/006316.html
%https://mail.python.org/pipermail/scipy-dev/2007-April/006972.html
%https://mail.python.org/pipermail/scipy-dev/2007-April/006835.html

% roadmap
%https://mail.python.org/pipermail/scipy-dev/2007-March/006808.html

% scikit learn
%https://mail.python.org/pipermail/scipy-dev/2007-July/007451.html
