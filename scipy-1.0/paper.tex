...
distributions (96 continuous and 13 dicrete univariate distributions
...
to evaluate the cumulative distribution function (cdf), the probability
...
distribution if available (such as a closed form expression of the
cdf or a sampling algorithm). Otherwise, default methods are used
