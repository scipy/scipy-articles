...
\end{quote}
While it is now more commonly accepted, Paul Dubois took the time to explain to
...
In addition to Paul Dubois' overview there were also articles introducing
...
When Paul Dubois edited the May/June 2007 special issue of the 
IEEE publication Computing in Science and Engineering (CiSE), 
Python already had a strong enough presence in science and engineering
that the editors solicited the endeavor. However, Python was still sufficiently
niche that the average reader
