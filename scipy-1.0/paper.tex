...
\subsection*{Test and benchmark suite}
    ...
    Consider the asv benchmark results shown in Figure~\ref{fig:asv-bench}, spanning roughly nine years of project history. These demonstrate the gradual performance
