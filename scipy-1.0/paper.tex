...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{static/cov}
\caption{\% coverage of the SciPy code base by unit tests over a five year
time span predeceding the 1.0 release point. The reconstitution of historical
