...
the user community that the package's API has now reached a level of
...
them without an official computer science education, or even the
blessing of their advisor.  To even imagine that a small group of
``rogue'' student programmers could upend the already well-established
research software ecosystem---backed by millions in funding, and
...
packages, and a variety of social activities around them.  The
packages in the ecosystem share high standards of implementation,
...
cause serious difficult) being perhaps the most serious.
