The SciPy library is organized as a collection of subpackages.  Here we
summarize the scope and capabilities of each subpackage.
...
\item[\texttt{stats}] ~ \newline
    ...
    correlations, Kendal's tau, chi-squared test and its generalization as the
